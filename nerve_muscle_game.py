...
MUSCLES = [
    ...
    {"id": "bic_lon",     "zh": "股二頭肌長頭", "en": "Biceps femoris (long head)",       "imgs": [31, 32], "nerves": ["tibial"],                "dual": False},
    {"id": "bic_sho",     "zh": "股二頭肌短頭", "en": "Biceps femoris (short head)",      "imgs": [33, 34], "nerves": ["com_fib"],               "dual": False},
